...
import com.oriondev.moneywallet.ui.fragment.secondary.DropBoxBackupHandlerFragment;
import com.oriondev.moneywallet.ui.fragment.secondary.ExternalMemoryBackupHandlerFragment;
import com.oriondev.moneywallet.ui.fragment.secondary.GoogleDriveBackupHandlerFragment;
...
public class BackupServices {
    ...
    private static final String SERVICE_ID_DROP_BOX = "DropBox";
    private static final String SERVICE_ID_GOOGLE_DRIVE = "GoogleDrive";
    ...
    public static List<BackupService> getBackupServices() {
        ...
        services.add(new BackupService(SERVICE_ID_DROP_BOX, R.drawable.ic_dropbox_24dp, R.string.service_backup_drop_box));
    ...
    public static Fragment getBackupServiceFragment(BackupService service, boolean allowBackup, boolean allowRestore) {
        switch (service.getIdentifier()) {
            case SERVICE_ID_DROP_BOX:
                return DropBoxBackupHandlerFragment.newInstance(allowBackup, allowRestore);
            case SERVICE_ID_GOOGLE_DRIVE:
                return GoogleDriveBackupHandlerFragment.newInstance(allowBackup, allowRestore);
